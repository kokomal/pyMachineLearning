...
class PyLouvain:
        ...
        while 1:
            ...
            for node in network[0]:
                ...
                for neighbor in self.get_neighbors(node):  
                    ...
                    if nb_community in communities:  
                        continue
                    ...
                    gain = self.compute_modularity_gain(node, nb_community, shared_links) 
                    if gain > best_gain:
    ...
    def make_initial_partition(self, network):  # network=(nodes, edges)
        ...
        for e in network[1]:
            if e[0][0] == e[0][1]:  # only self-loops ��ѭ����s_inҪdouble
    ...
    def second_phase(self, network, partition):
        ...
        print("NEW COMMUNITY " , self.communities)  
